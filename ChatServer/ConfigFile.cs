...
namespace ChatClientWPF
{
    class ConfigFile
    {
        ...
        public ConfigFile()
        {
            ...
            {
                _configList.Add(new Config("host", "127.0.0.1"));
                _configList.Add(new Config("port", "1"));
                _configList.Add(new Config("login", "root"));
                _configList.Add(new Config("password", "root"));
                _configList.Add(new Config("database", "name"));
                Save();
            }
        }
